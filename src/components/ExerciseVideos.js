...
const ExerciseVideos = ({ exerciseVideos, name }) => {
  ...
  return (
    <Box sx={{ marginTop: { lg: '12.6875rem', xs: '1.25rem' } }} p="1.25rem">
      ...
      <Stack sx={{ flexDirection: { lg: 'row' }, gap: { lg: '6.875rem', xs: '0rem' } }} justifyContent="flex-start" flexWrap="wrap" alignItems="center">
        {exerciseVideos?.slice(0, 3)?.map((item, index) => (
          ...
          >
            ...
            <Box>
              <Typography sx={{ fontSize: { lg: '1.75rem', xs: '1.125rem' } }} fontWeight={600} color="#000">
                {item.video.title}
              </Typography>
